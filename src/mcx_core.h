...
typedef struct  __declspec(align(16)) MCXDir{
...
typedef struct  __declspec(align(16)) MCXTimer{
...
typedef union  __declspec(align(16)) GPosition{
	MCXpos d;
	float4 v;
	float  f[4];
}Gpos;

typedef union  __declspec(align(16)) GDirection{
        MCXdir d;
        float4 v;
	float  f[4];
}Gdir;

typedef union  __declspec(align(16)) GLength{
        MCXtime d;
        float4 v;
	float  f[4];
}Glen;

typedef union  __declspec(align(16)) GProperty{
...
typedef struct  __declspec(align(16)) KernelParams {
